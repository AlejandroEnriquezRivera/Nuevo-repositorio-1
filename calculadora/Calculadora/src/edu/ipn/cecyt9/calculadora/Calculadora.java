...
public class Calculadora extends JFrame {
	...
	public Calculadora() {
		super();
                /**
                 * Se modificó el tamaño a 400 x 400
                 */
		setSize(400, 400);
		...
		nuevoBotonOperacion("/");
                /**
                 * Se agregaron nuevos botones a la calculadora
                 * se agregó el botón de exponente
                 * se agregó el botón raíz cuadrada
                 * se agregó el botón Seno
                 * se agregó el botón Logaritmo
                 * se agregó el botón Factorial
                 */
                nuevoBotonOperacion("^");
                nuevoBotonOperacion("√");
	...
	private void calcularResultado() {
             ...
             * Se agregó la variable auxiliar "aux" para poder realizar la operación de factorial
             */
            int aux = Integer.parseInt(pantalla.getText());
            aux=aux-1;
		if (operacion.equals("+")) {
                    resultado += new Double(pantalla.getText());
		} 
             ...
             * Se agregó la función exponencial
             */
                                if(operacion.equals("^")){
             ...
             * Se agregó la función Logaritmo
             */
             ...
             * Se agregó la función Factorial
             */
                                                if(operacion.equals("!")){
                                                    while(aux!=0){
